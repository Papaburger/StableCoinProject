...
contract DSCEngineTest is Test {
    ...
    function setUp() public {
        ...
        (ethUsdPriceFeed, btcUsdPriceFeed, weth,,) = config.activeNeworkConfig();
    ...
    function testGetTokenAmountFromUsd() public {
        ...
        uint256 atualWeth = dsce.getTokenAmountFromUsd(weth, usdAmount);
        assertEq(expectedWeth, atualWeth);
    }
